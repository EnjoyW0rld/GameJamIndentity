...
public class RoomInstance : MonoBehaviour
{
    ...
    private void SpawnEnemies()
    {
        ...
        {
            int targetEnemy = Random.Range(0,_enemyPrefab.Length);
            ...
            EnemyBase enemy = Instantiate(_enemyPrefab[targetEnemy], spawnPos, _enemyPrefab[targetEnemy].transform.rotation);
        }
    }
